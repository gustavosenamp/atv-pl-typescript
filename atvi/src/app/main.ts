...
import CadastroCliente from "../negocio/register/cadastroCliente";
import CadastroConsumo from "../negocio/register/cadastroConsumo";
import CadastroPet from "../negocio/register/cadastroPet";
import CadastroProduto from "../negocio/register/cadastroProduto";
import CadastroServico from "../negocio/register/cadastroServico";
import DeleteCliente from "../negocio/delete/deleteCliente";
import DeletePet from "../negocio/delete/deletePet";
import DeleteProduto from "../negocio/delete/deleteProduto";
import DeleteServico from "../negocio/delete/deleteServico";
import ListagemClientes from "../negocio/list/listagemClientes";
import ListagemConsumoPorRaca from "../negocio/list/listagemConsumoPorPet";
import ListagemConsumoTop5PorValor from "../negocio/list/listagemConsumoTop5PorValor";
import ListagemPets from "../negocio/list/listagemPets";
import ListagemConsumo from "../negocio/list/listagemProdEServConsumidos";
import ListagemProdEServMaisConsumidos from "../negocio/list/listagemProdEServMaisConsumidos";
import ListagemProdutos from "../negocio/list/listagemProdutos";
import ListagemServicos from "../negocio/list/listagemServicos";
import ListagemConsumoTop10 from "../negocio/list/listagemTop10";
